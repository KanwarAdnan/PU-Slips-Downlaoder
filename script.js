...
function downloadSlips() {
    ...
    let apiUrl;
    if (slipType === 'exam') {
        apiUrl = `http://ec2-3-108-62-49.ap-south-1.compute.amazonaws.com:8000/download_slip?roll_no=${rollNumber}`;
    } else if (slipType === 'practical') {
        apiUrl = `http://ec2-3-108-62-49.ap-south-1.compute.amazonaws.com:8000/download_practical_slip?roll_no=${rollNumber}`;
    }
    else if (slipType === 'adp') {
        apiUrl = `http://ec2-3-108-62-49.ap-south-1.compute.amazonaws.com:8000/download_adp_slip?roll_no=${rollNumber}`;
    }
